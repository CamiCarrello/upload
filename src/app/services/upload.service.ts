...
export class UploadService {
  ...
  getTagVideo(id: string) {
    return this.http.get<Video[]>(BASE_URL + 'videos/tag/' + id);
  }
  ...
  postCommentChannel(id_channel: number, name: string, email: string, comment: string, callback?: any) {
    ...
    this.http.post(BASE_URL_RAW + 'comment', post_comment_channel).subscribe(callback);
  }
